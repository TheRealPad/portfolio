...
import { _defineProperty, init_defineProperty } from "./chunk-TVXNE7JQ.js";
import { _classCallCheck, _createClass } from "./chunk-D3EHZ3HS.js";
import { _typeof, init_typeof } from "./chunk-SR3OVNSJ.js";
...
function n(n2) {
  ...
  if (
    i2 &&
    ((r2.name = i2[1]),
    (import_void_elements.default[i2[1]] || "/" === n2.charAt(n2.length - 2)) &&
      (r2.voidElement = true),
    r2.name.startsWith("!--"))
  ) {
    var s2 = n2.indexOf("-->");
  ...
  for (var a2 = new RegExp(t), c2 = null; null !== (c2 = a2.exec(n2)); )
    if (c2[0].trim())
      if (c2[1]) {
        ...
        c2[2] &&
          (r2.attrs[c2[2]] = c2[3].trim().substring(1, c2[3].length - 1));
  return r2;
}
var r = /<[a-zA-Z0-9\-\!\/](?:"[^"]*"|'[^']*'|[^'">])*>/g;
var i = /^\s*$/;
  ...
  switch (t2.type) {
    ...
    case "tag":
      return (
        ...
        t2.voidElement
          ? e2
          : e2 + t2.children.reduce(a, "") + "</" + t2.name + ">"
      );
    case "comment":
      ...
      e2.replace(r, function (r2, s2) {
        ...
        if (
          (f &&
            (l++,
            "tag" === (a2 = n(r2)).type &&
              t2.components[a2.name] &&
              ((a2.type = "component"), (m = true)),
            a2.voidElement ||
              m ||
              !d ||
              "<" === d ||
            ...
            0 === l && c2.push(a2),
            (u2 = o[l - 1]) && u2.children.push(a2),
            (o[l] = a2)),
          (!f || a2.voidElement) &&
            (l > -1 &&
              (a2.voidElement || a2.name === r2.slice(2, -1)) &&
              (l--, (a2 = -1 === l ? c2 : o[l])),
            !m && "<" !== d && d))
        ) {
          u2 = -1 === l ? c2 : o[l].children;
          var x = e2.indexOf("<", p),
            g = e2.slice(p, -1 === x ? void 0 : x);
          i.test(g) && (g = " "),
            ((x > -1 && l + u2.length >= 0) || " " !== g) &&
              u2.push({ type: "text", content: g });
        }
      }),
      c2
    );
...
function oldI18nextHasLoadedNamespace(ns, i18n) {
  ...
  var loadNotPending = function loadNotPending2(l, n2) {
    var loadState =
      i18n.services.backendConnector.state["".concat(l, "|").concat(n2)];
  ...
  return i18n.hasLoadedNamespace(ns, {
    ...
    precheck: function precheck(i18nInstance2, loadNotPending) {
      if (
        options.bindI18n &&
        options.bindI18n.indexOf("languageChanging") > -1 &&
        i18nInstance2.services.backendConnector.backend &&
        i18nInstance2.isLanguageChangingTo &&
        !loadNotPending(i18nInstance2.isLanguageChangingTo, ns)
      )
        return false;
    },
  });
...
function renderNodes(
  ...
  getData(children);
  var ast = html_parse_stringify_module_default.parse(
    "<0>".concat(targetString, "</0>")
  );
  ...
  function mapAST(reactNode, astNode, rootReactNode) {
    ...
    return astNodes.reduce(function (mem, node, i2) {
      ...
      if (node.type === "tag") {
        ...
        if (typeof child === "string") {
          var value = i18n.services.interpolator.interpolate(
            child,
            opts,
            i18n.language
          );
          ...
          if (isKnownComponent) {
            ...
            if (node.voidElement) {
              mem.push(
                (0, import_react.createElement)(node.name, {
...
function Trans(_ref) {
  ...
  var useAsParent =
    parent !== void 0 ? parent : reactI18nextOptions.defaultTransParent;
  return useAsParent
    ? (0, import_react.createElement)(useAsParent, additionalProps, content)
    : content;
}
  ...
  return function (ctx) {
    return new Promise(function (resolve) {
      ...
      if (ForComponent.getInitialProps) {
        ForComponent.getInitialProps(ctx).then(function (
          componentsInitialProps
        ) {
          resolve(
            _objectSpread3(
              _objectSpread3({}, componentsInitialProps),
              i18nInitialProps
            )
          );
        });
...
function getInitialProps() {
  var i18n = getI18n();
  var namespaces = i18n.reportNamespaces
...
function Trans2(_ref) {
  var children = _ref.children,
    ...
    tFromProps = _ref.t,
    shouldUnescape = _ref.shouldUnescape,
    additionalProps = _objectWithoutProperties(_ref, _excluded3);
  var _ref2 = (0, import_react3.useContext)(I18nContext) || {},
    ...
    try {
      if (((_x = (_i = _i.call(arr)).next), 0 === i2)) {
        ...
        for (
          ...
          (_arr.push(_s.value), _arr.length !== i2);
          _n = true
        );
    } catch (err) {
      (_d = true), (_e = err);
...
function useTranslation(ns) {
  ...
  var _ref = (0, import_react4.useContext)(I18nContext) || {},
  ...
  if (!i18n) {
    ...
    var notReadyT = function notReadyT2(k, optsOrDefaultValue) {
      ...
      if (
        optsOrDefaultValue &&
        _typeof(optsOrDefaultValue) === "object" &&
  ...
  var i18nOptions = _objectSpread5(
    _objectSpread5(_objectSpread5({}, getDefaults()), i18n.options.react),
    props
  );
  var useSuspense = i18nOptions.useSuspense,
    keyPrefix = i18nOptions.keyPrefix;
  var namespaces =
    ns || defaultNSFromContext || (i18n.options && i18n.options.defaultNS);
  namespaces =
    typeof namespaces === "string"
      ? [namespaces]
      : namespaces || ["translation"];
  ...
  var _useState = (0, import_react4.useState)(getT),
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      ...
      var _useTranslation = useTranslation(
        ...
        t2 = _useTranslation2[0],
        i18n = _useTranslation2[1],
        ready = _useTranslation2[2];
      var passDownProps = _objectSpread6(
        _objectSpread6({}, rest),
        {},
        {
          t: t2,
    ...
    return options.withRef
      ? (0, import_react5.forwardRef)(forwardRef)
      : I18nextWithTranslation;
  };
}
...
function Translation(props) {
  var ns = props.ns,
    ...
    options = _objectWithoutProperties(props, _excluded5);
...
function I18nextProvider(_ref) {
  ...
  var value = (0, import_react6.useMemo)(
    function () {
      return {
        i18n,
        defaultNS,
...
function useSSR(initialI18nStore, initialLanguage) {
  var props =
    arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  var i18nFromProps = props.i18n;
  var _ref = (0, import_react7.useContext)(I18nContext) || {},
    i18nFromContext = _ref.i18n;
  var i18n = i18nFromProps || i18nFromContext || getI18n();
  if (i18n.options && i18n.options.isClone) return;
  if (initialI18nStore && !i18n.initializedStoreOnce) {
    i18n.services.resourceStore.data = initialI18nStore;
    i18n.options.ns = Object.values(initialI18nStore).reduce(function (
      mem,
      lngResources
    ) {
...
function withSSR() {
  return function Extend(WrappedComponent) {
    ...
    I18nextWithSSR.displayName = "withI18nextSSR(".concat(
      getDisplayName(WrappedComponent),
      ")"
    );
