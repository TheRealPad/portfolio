import { init_redux, redux_exports } from "./chunk-GDBFQKJW.js";
import "./chunk-TVXNE7JQ.js";
import "./chunk-SR3OVNSJ.js";
import { __commonJS, __toCommonJS } from "./chunk-AC2VUBZ6.js";

// node_modules/redux-dynamic-middlewares/lib/index.js
var require_lib = __commonJS({
  "node_modules/redux-dynamic-middlewares/lib/index.js"(exports) {
    exports.__esModule = true;
    exports.createDynamicMiddlewares =
      exports.resetMiddlewares =
      exports.removeMiddleware =
    ...
    var createDynamicMiddlewares = function createDynamicMiddlewares2() {
      ...
      var addMiddleware2 = function addMiddleware3() {
        ...
        (_allApplyedDynamicMid = allApplyedDynamicMiddlewares).push.apply(
          _allApplyedDynamicMid,
          middlewares.map(function (middleware) {
            return middleware(store);
          })
        );
        (_allDynamicMiddleware = allDynamicMiddlewares).push.apply(
          _allDynamicMiddleware,
          middlewares
        );
      };
      var removeMiddleware2 = function removeMiddleware3(middleware) {
        ...
        allDynamicMiddlewares = allDynamicMiddlewares.filter(function (
          _,
          mdwIndex
        ) {
