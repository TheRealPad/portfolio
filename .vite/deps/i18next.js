        ...
        value: function translate(keys, options, lastKey) {
          ...
          if (
            ...
            if (!options.returnObjects && !this.options.returnObjects) {
              ...
              var r = this.options.returnedObjectHandler
                ...
                if (this.options.saveMissingPlurals && needsPluralHandling) {
                  lngs.forEach(function (language) {
                    _this2.pluralResolver
                      .getSuffixes(language, options)
                      .forEach(function (suffix) {
                        send(
                          [language],
                          key + suffix,
                          options["defaultValue".concat(suffix)] || defaultValue
                        );
                      });
                  });
                } else {
          ...
          if (this.i18nFormat && this.i18nFormat.parse) {
            ...
            if (options.interpolation)
              this.interpolator.init(
                _objectSpread$4(_objectSpread$4({}, options), {
                  interpolation: _objectSpread$4(
                    _objectSpread$4({}, this.options.interpolation),
      ...
      },
      {
        ...
        value: function resolve(keys) {
          ...
          keys.forEach(function (k) {
            ...
            var needsPluralHandling =
              options.count !== void 0 && typeof options.count !== "string";
            var needsZeroSuffixLookup =
              needsPluralHandling &&
              !options.ordinal &&
              options.count === 0 &&
              _this4.pluralResolver.shouldUseIntlApi();
            ...
            namespaces.forEach(function (ns) {
              ...
              codes.forEach(function (code) {
                ...
                if (_this4.i18nFormat && _this4.i18nFormat.addLookupKeys) {
                  ...
                  var zeroSuffix = "".concat(
                    _this4.options.pluralSeparator,
                    "zero"
                  );
                  if (needsPluralHandling) {
      ...
      value: function toResolveHierarchy(code, fallbackCode) {
        ...
        var addCode = function addCode2(c) {
          ...
          if (_this2.isSupportedCode(c)) {
            ...
            _this2.logger.warn(
              "rejecting language code not found in supportedLngs: ".concat(c)
            );
          }
        };
        if (typeof code === "string" && code.indexOf("-") > -1) {
    ...
    },
    {
      ...
      value: function getSuffixes(code) {
        ...
        if (this.shouldUseIntlApi()) {
          return rule
            .resolvedOptions()
            .pluralCategories.sort(function (pluralCategory1, pluralCategory2) {
              return (
  ...
  _createClass(Interpolator2, [
    {
      ...
      value: function init2() {
        ...
        this.escapeValue =
          iOpts.escapeValue !== void 0 ? iOpts.escapeValue : true;
        this.useRawValueToEscape =
          iOpts.useRawValueToEscape !== void 0
        ...
        this.alwaysFormat =
          iOpts.alwaysFormat !== void 0 ? iOpts.alwaysFormat : false;
        this.resetRegExp();
      },
    },
    {
      ...
      value: function interpolate(str, data, lng, options) {
        ...
        var handleFormat = function handleFormat2(key) {
          if (key.indexOf(_this.formatSeparator) < 0) {
            var path = deepFindWithDefaults(
              data,
              defaultData,
              key,
              _this.options.keySeparator,
              _this.options.ignoreJSONStructure
            );
            return _this.alwaysFormat
              ? _this.format(
                  ...
                  lng,
                  _objectSpread$3(
                    _objectSpread$3(_objectSpread$3({}, options), data),
                    {},
                    {
              ...
              if (typeof missingInterpolationHandler === "function") {
                ...
                _this.logger.warn(
                  "missed to pass in variable "
                    .concat(matchedVar, " for interpolating ")
                    .concat(str)
                );
                value = "";
              }
          ...
          if (_this.formats[formatName]) {
            ...
            try {
              ...
              var l =
                ...
                options.lng ||
                lng;
              formatted = _this.formats[formatName](
                mem,
                l,
                _objectSpread$2(
                  _objectSpread$2(_objectSpread$2({}, formatOptions), options),
                  valOptions
                )
              );
            } catch (error2) {
            ...
            _this.logger.warn(
              "there was no format function for ".concat(formatName)
            );
          }
          return mem;
        }, value);
  ...
  _createClass(I18n2, [
    {
      ...
      value: function init2() {
        ...
        this.options = _objectSpread(
          _objectSpread(_objectSpread({}, defOpts), this.options),
          transformOptions(options)
        );
        if (this.options.compatibilityAPI !== "v1") {
          this.options.interpolation = _objectSpread(
            _objectSpread({}, defOpts.interpolation),
            this.options.interpolation
          );
        }
        ...
        var setLng = function setLng2(lngs) {
          ...
          if (l) {
            ...
            if (
              ...
              _this4.services.languageDetector.cacheUserLanguage
            )
    ...
    },
    {
      ...
      value: function getFixedT2(lng, ns, keyPrefix) {
        ...
        var fixedT = function fixedT2(key, opts) {
          ...
          options.keyPrefix =
            options.keyPrefix || keyPrefix || fixedT2.keyPrefix;
          var keySeparator = _this5.options.keySeparator || ".";
          var resultKey;
          if (options.keyPrefix && Array.isArray(key)) {
            resultKey = key.map(function (k) {
              return ""
                .concat(options.keyPrefix)
                .concat(keySeparator)
                .concat(k);
            });
          } else {
            resultKey = options.keyPrefix
              ? "".concat(options.keyPrefix).concat(keySeparator).concat(key)
              : key;
          }
    ...
    },
    {
      ...
      value: function dir2(lng) {
        ...
        return rtlLngs.indexOf(languageUtils.getLanguagePartFromCode(lng)) >
          -1 || lng.toLowerCase().indexOf("-arab") > 1
          ? "rtl"
          : "ltr";
      },
    },
